...
// const HostModal = ({ coloseModal,isModalOpen , modalHandler }) => {
//     return (
//         <div>
//             <Transition    appear show={isModalOpen}
//                 // as={"Fragment"}
//             >
//       <Dialog as='div' className='relative z-10' onClose={coloseModal}>
//         <TransitionChild
//           as={"Fragment"}
...
const HostModal = ({ closeModal, isModalOpen, modalHandeler }) => {
  return (
    <div>
